...
{
public:
  // Attempts to create an allocator using the given name. Leave the
  // name empty for a built-in DRF allocator or specify it to load
  // allocator instance from a module.
