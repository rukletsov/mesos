...
public:
   ...
   * apply to the authorization actions. Please check "authorizer.proto" and
   * "docs/authorization.md" for details.
   *
   ...
   *
   * TODO(arojas): This funcion is relevant for the default implementation
  ...
  /**
   * Verifies whether a principal can shut down a framework launched by another
   * principal.
   *
   * @param request `ACL::ShutdownFramework` packing all the parameters needed
   *     to verify the given principal can shut down a framework launched by
   *     the framework principal, who originally registered the framework.
   *
   ...
   *     in the request, false otherwise. A failed future indicates a problem
