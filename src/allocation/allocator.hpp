...
// TODO(alexr): This goes away once dependency on master::Flags is
// removed.
...
//
// This is the public API. Every allocator should implement this
// interface.
// TODO(alexr): Add an explanatory comment on all interface calls.
class Allocator
{
public:
  Allocator() {}
