...
Status MesosExecutorDriver::start()
{
  synchronized (mutex) {
    ...
    //
    // NOTE: We do not require this variable to be set (in
    // contrast to others above) for the backwards-compatibility
    // reason: agents prior to 0.28.0 do not set this variable.
