...
private:
  ...
  private:
    // Authorizes access to an HTTP endpoint.
    // It extracts the endpoint from the URL of the request by removing
    // the "/slave(n)" part of the URL's path. The request's method
