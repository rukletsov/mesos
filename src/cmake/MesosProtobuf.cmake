...
# PROTOC_GENERATE is a convenience function that will: (1) compile .proto files
# found in the Mesos public-facing `include/` directory, or with the option
# `SRC` the Mesos `src/` directory, (2) place the generated files in the build
# folder, but with an identical directory structure, and (3) append to variables
# holding the fully qualified path to the generated files, namely
# `PUBLIC_PROTOBUF_SRC`, `INTERNAL_PROTOBUF_SRC`, and `JAVA_PROTOBUF_SRC`. This
# export is a *side effect* and modifies the variables in the public scope.
# The `JAVA` flag will generate the Java Protobuf files to `src/java/generated`.
#
...
#
# Where `mesos/mesos.proto` would be the relative path to the .proto file, we'd
# use this "root name" to generate files like `mesos/mesos.pb.cc`
#
...
function(PROTOC_GENERATE)
  ...
  set(PROTOC_OPTIONS -I${MESOS_PUBLIC_INCLUDE_DIR} -I${MESOS_SRC_DIR} --cpp_out=${CPP_OUT})
  if (PROTOC_JAVA AND HAS_JAVA)
    list(APPEND PROTOC_OPTIONS --java_out=${MESOS_BIN_SRC_DIR}/java/generated)
  endif ()
  ...
  list(APPEND PROTOBUF_PROTO ${PROTO})
  set(PROTOBUF_PROTO ${PROTOBUF_PROTO} PARENT_SCOPE)
