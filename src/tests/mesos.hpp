...
public:
  ...
  // TestAllocator owns the underlying real allocator, which cannot
  // be cloned here. Therefore replace copy c-tor by move c-tor once
  // it is available to us.
  TestAllocator(const TestAllocator& other) : real(other.real) {}
