...
template <typename T = allocation::HierarchicalDRFAllocator>
class MockAllocator : public allocation::Allocator
{
public:
  MockAllocator()
  {
...
{
  allocator->real.transformAllocation(arg0, arg1, arg2);
}
