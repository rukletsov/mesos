...
// implicitly ensured by invoking all interface functions. Note that
// we use MesosAllocatorProcess and not the template parameter
// AllocatorProcess in dispatch calls.
